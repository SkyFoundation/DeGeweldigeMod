...
import com.pixelsky.cheese.world.populator.BlockDecorator;
import com.pixelsky.cheese.world.populator.BlockPopulator;
import com.pixelsky.cheese.world.populator.GrassPopulator;
import com.pixelsky.cheese.world.populator.TreeDecorator;
...
public class ChunkProviderCheese implements IChunkGenerator {
    ...
    double[] depthRegion;
    private List<BlockPopulator> genPopulators = Lists.newArrayList();
    private List<BlockDecorator> genDecorators = Lists.newArrayList();
    ...
    public ChunkProviderCheese(World worldIn, long seed, boolean mapFeaturesEnabledIn, String p_i46668_5_) {
        ...
        this.genDecorators.add(new TreeDecorator());
        this.genPopulators.add(new GrassPopulator());
    }
...
//        this.setUpBiome(x,z);
        ...
        for (BlockPopulator populator:genPopulators)
            populator.populate(this.worldObj,x,z,this.rand,chunkprimer);
    ...
    public void populate(int x, int z) {
        ...
        if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && this.settings.useWaterLakes && !flag
            ...
            if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, this.worldObj, this.rand, x, z, flag,
                ...
                (new WorldGenLakes(CheeseBlocks.CHEESE_LIQUID)).generate(this.worldObj, this.rand, blockpos.add(i1, j1, k1));
            }
        ...
        for (BlockDecorator decorator:genDecorators)
            decorator.decorate(this.worldObj,x,z,this.rand,this.worldObj.getChunk(x,z));
